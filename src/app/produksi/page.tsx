...
export default function ProduksiPage() {
  ...
  const hitung = () => {
    ...
    setError(null)
    setResult(r.data!)
    saveHistory("produksi", { umur_tahun: Math.floor(u), luas_ha: l, faktor_kelas_lahan: parseNum(kelas) ?? 1 }, r.data!, blokId === "__none__" ? null : blokId || null)
  }
      ...
      <div className="grid gap-6 px-6 py-6 lg:px-10 xl:grid-cols-2">
        ...
        <ResultPanel
          ...
          rows={
            result
              ? [
                  { label: "Produksi per ha", value: result.ton_per_ha.toLocaleString("id-ID"), unit: "ton/ha" },
